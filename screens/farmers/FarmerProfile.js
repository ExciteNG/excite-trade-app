    ...
    items: [
      {
        key: "FarmerWallet",
        label: "My Wallet",
        sub: "Manage payout account",
        Icon: Wallet,
        iconBg: "#F0FDF4",
        iconColor: "#22C55E",
      },
      {
        key: "FarmerFinancialAid",
        label: "Financial Aid",
        sub: "EMI loan calculator",
        Icon: TrendingUp,
        iconBg: "#EFF6FF",
        iconColor: "#3B82F6",
      },
...
const FarmerProfile = ({ navigation }) => {
  ...
  const clusterName = userInfo?.profile?.clusterDetail?.clusterName ?? "—";
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <View className='flex-row items-center'>
            <View className='w-16 h-16 rounded-full bg-[#F0FDF4] border-2 border-[#A7CC48] items-center justify-center mr-4'>
            ...
            <View className='flex-1'>
              ...
              <View className='flex-row items-center gap-1.5 mt-1.5'>
                <View className='bg-[#F0FDF4] border border-[#BBF7D0] px-2 py-0.5 rounded-full flex-row items-center gap-1'>
          ...
          <View className='flex-row mt-4 pt-4 border-t border-gray-50 gap-0'>
            {[
              ...
              >
                <Text className='text-[15px] font-[800] text-gray-800'>
                  {stat.value}
                </Text>
